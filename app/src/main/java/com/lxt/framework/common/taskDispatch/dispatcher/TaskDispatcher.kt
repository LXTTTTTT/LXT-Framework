package com.lxt.framework.common.taskDispatch.dispatcher

import android.app.Application
import android.os.Looper
import android.util.Log
import androidx.annotation.UiThread
import com.lxt.framework.common.taskDispatch.task.DispatchRunnable
import com.lxt.framework.common.taskDispatch.state.StaterUtils
import com.lxt.framework.common.taskDispatch.task.Task
import com.lxt.framework.common.taskDispatch.task.TaskCallBack
import com.lxt.framework.common.taskDispatch.sort.TaskSortUtil
import com.lxt.framework.common.taskDispatch.state.TaskStat
...
class TaskDispatcher private constructor() {
    ...
    private fun executeTaskMain() {
        ...
        for (task in mMainThreadTasks) {
            ...
            Log.i(TAG, "任务 ${task.javaClass.simpleName} 消耗 ${(System.currentTimeMillis() - time)}")
        }
